...
logging.basicConfig(
    ...
    datefmt="%Y-%m-%d %H:%M:%S",
    filename="logs/fourth_pipeline.log",
    filemode="w",
    level=logging.INFO,
)
...
async def fourth_pipeline(
    ...
    try:
        ...
        report_task = asyncio.create_task(
            consume_from_kafka(threat_sources_consumer, logger, kafka_second_topic)
        )
